namespace GraphicsResearch.Generation.Grids
{
    ...
    public abstract class DataGrid : MonoBehaviour
    {
        ...
        public static int GetColumn(Vector2 position, Vector3 topLeft, Vector2 boxSize, int numCols)
        {
            Vector2 pos = topLeft;
        ...
        public static Vector3 GetPosition(int r, int c, Vector3 topLeft, Vector2 boxSize)
        {
