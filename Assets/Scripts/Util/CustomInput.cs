namespace GraphicsResearch.Util
{
    ...
    public class CustomInput : MonoBehaviour
    {
        ...
        {
            DartThrow_Circle, DartThrow_Rect, DartThrow_Repulse, DartThrow_Jittered, DartThrow_ShowObjects,
            Vst_Calculate, Vst_Randomized, Vst_Ordered,
            Rasterize_Rasterize, Rasterize_GenMesh
        }
        ...
        public static void RawSign()
        {
            ...
            rawSign[(int)UserInput.DartThrow_Circle] = 1;
            rawSign[(int)UserInput.DartThrow_Rect] = 1;
            rawSign[(int)UserInput.DartThrow_Repulse] = 1;
            rawSign[(int)UserInput.DartThrow_Jittered] = 1;
            rawSign[(int)UserInput.DartThrow_ShowObjects] = 1;
            rawSign[(int)UserInput.Vst_Calculate] = 1;
            rawSign[(int)UserInput.Vst_Randomized] = 1;
            rawSign[(int)UserInput.Vst_Ordered] = 1;
            rawSign[(int)UserInput.Rasterize_Rasterize] = 1;
            rawSign[(int)UserInput.Rasterize_GenMesh] = 1;
        }
        ...
        public static void DefaultKey()
        {
            ...
            keyboard[(int)UserInput.DartThrow_Circle, 0] = KeyCode.Alpha1;
            keyboard[(int)UserInput.DartThrow_Rect, 0] = KeyCode.Alpha2;
            keyboard[(int)UserInput.DartThrow_Repulse, 0] = KeyCode.A;
            keyboard[(int)UserInput.DartThrow_Jittered, 0] = KeyCode.J;
            keyboard[(int)UserInput.DartThrow_ShowObjects, 0] = KeyCode.Space;
            keyboard[(int)UserInput.Vst_Calculate, 0] = KeyCode.M;
            keyboard[(int)UserInput.Vst_Randomized, 0] = KeyCode.R;
            keyboard[(int)UserInput.Vst_Ordered, 0] = KeyCode.O;
            keyboard[(int)UserInput.Rasterize_Rasterize, 0] = KeyCode.X;
            keyboard[(int)UserInput.Rasterize_GenMesh, 0] = KeyCode.Z;
        }
